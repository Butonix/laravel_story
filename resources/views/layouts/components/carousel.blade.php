...
<!-- </li> -->
    ...
    <div class="col-xs-12 col-sm-2 col-md-1" style="margin-top: 15px; //border: 1px solid red;">
        <a href="http://facebook.com" target="_blank"><img src="{{ url('images/icons/facebook.png') }}"
                                                           style="height: 50px; margin-right: 10px; //border: 1px solid red;"
                                                           alt=""></a>
        ...
        <div class="col-xs-12 col-sm-5 col-md-7" style="margin-top: 15px;">
            ...
            <div class="form-group">
                <div class="icon-addon addon-lg">
                    <input type="text" class="form-control" name="txt_search" id="txt_search"
