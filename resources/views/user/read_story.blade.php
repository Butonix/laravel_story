          ...
          <div class="table-responsive">
            <table class="table remove-border">
              ...
              <tbody>
                <tr>
                  <td>นักเขียน</td>
                  <td><a href="{{ url('user/profile/'.$story->story_author) }}">{{ $story->story_author }}</a></td>
                </tr>
                <tr>
                  <td>หมวดนิยาย</td>
                  <td>{{ $category_name }}</td>
...
<div class="row">
  ...
  <div class="form-group text-center">
    <a href="{{ url('user/write/story/sub/'.$id) }}"><button type="button" class="btn btn-primary" style="width: 20%; font-size: 18px;">เพิ่มตอนใหม่ <i class="fa fa-plus"></i></button></a>
  </div>
