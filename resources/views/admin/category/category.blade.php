    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <a href="{{ url('admin/category/all') }}" style="margin-right: 10px; color: green;"><i
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach ($categorys as $category)
                        <tr>
                            ...
                            <td><a href="{{ url('admin/category/edit/'.$category->id) }}"><i class="fa fa-pencil"></i>
                                    แก้ไข</a></td>
                            <td><a href="{{ url('admin/category/delete/'.$category->id) }}" style="color: red;"><i
